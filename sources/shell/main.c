...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/01 19:17:20 by hamchur           #+#    #+#             */
/*   Updated: 2022/04/01 19:17:22 by hamchur          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	prompt(char **envp)
{
	...
	while (str[index])
	{
		...
		if (index == 1000)
			index = 0;
		set_signals();
		str[index] = readline("на минишелычах$ ");
	}
	if (str[index])
		free(str[index]);
	return (0);
